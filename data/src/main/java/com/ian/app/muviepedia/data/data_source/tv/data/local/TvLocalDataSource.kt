package com.ian.app.muviepedia.data.data_source.tv.data.local

import com.ian.app.muviepedia.data.MovieDatabase
import com.ian.app.muviepedia.data.data_source.tv.data.local.model.TvPopularData
import com.ian.app.muviepedia.data.data_source.tv.data.local.model.TvSaveDetailData
import com.ian.app.muviepedia.data.data_source.tv.data.local.model.TvSearchLocalData
...
class TvLocalDataSource(private val db: MovieDatabase) {
    ...
    fun loadAllTvShowDataById(selectedId: Int) = db.tvSaveDetailDao().loadAllTvShowDataById(selectedId)

    suspend fun deleteAllData() = db.tvSaveDetailDao().deleteAllData()
