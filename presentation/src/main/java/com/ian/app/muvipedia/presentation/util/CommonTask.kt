...
import com.ian.app.muvipedia.presentation.R
...
private fun saveImage(views: View, bitmap: Bitmap?) {
    ...
    voidCustomMediaScannerConnection(
        views.context,
        saveImagePath
    )
}
...
private fun openImageFromSnackbar(views: View, imageFile: File) {
    val snackbar = Snackbar
            ...
            .setAction("OPEN") {
                ...
                val uri = FileProvider.getUriForFile(views.context, views.context.resources.getString(
                    R.string.package_name), imageFile)
